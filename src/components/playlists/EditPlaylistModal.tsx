...
interface EditPlaylistModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSave: (name: string, cover?: string) => Promise<void>;
    playlist: { name: string; cover?: string } | null;
}

export function EditPlaylistModal({ isOpen, onClose, onSave, playlist }: EditPlaylistModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            await onSave(name.trim(), cover.trim() || undefined);
            onClose();
        } catch (error) {
        ...
        <div className="modal-overlay" style={{
            ...
            <div className="modal-content" style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <h2 style={{ fontSize: 'var(--text-xl)', fontWeight: 'var(--font-bold)' }}>Edit Playlist</h2>
